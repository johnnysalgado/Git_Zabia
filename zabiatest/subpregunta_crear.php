<?php
    ...
    if (isset($_POST["id_pregunta"])) {
        ...
        $idSubpregunta = $daoCuestionario->crearSubpregunta($idPregunta, $descripcion, $descripcionIngles, $tipoRespuesta, $orden, $datoEspecial, $valorMinimo, $valorMaximo, $usuario);
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h4 class="page-title">Creaci&oacute;n de sub pregunta para: <?php echo $tituloPregunta; ?></h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="subpregunta_crear.php" method="post" id="forma">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <input type="hidden" id="id_pregunta" name="id_pregunta" value="<?php echo $idPregunta; ?>" />
                            </form>
                        </div>
                    </div>
                </div>
