<?php
    ...
    if (isset($_POST["nombre"])) {
        ...
        $resultado = $daoNutriente->crearTipoNutriente($nombre, $nombreIngles, $usuario);
        $daoNutriente = null;
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Creaci&oacute;n de Tipo nutriente</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="tipo_nutriente_crear.php" method="post" name="forma" id="forma">
                                <div class="row">
                                    <div class="col-md-6">
