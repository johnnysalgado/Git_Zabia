                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Modificaci&oacute;n de terapia alternativa</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="terapiaalternativa_editar.php" method="post" enctype="multipart/form-data" name="forma_grocery" id="forma-grocery">
                                <div class="row">
                                    <div class="col-md-6">
