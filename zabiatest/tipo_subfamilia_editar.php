<?php
    ...
    if (isset($_POST["tipo_subfamilia"])) {
        ...
        $resultado = $daoNutriente->editarTipoSubfamilia($idTipoSubfamilia, $nombre, $nombreIngles, $estado, $usuario);
        $daoNutriente = null;
    ...
    if (isset($_GET["id"])) {
        ...
        if ($idTipoSubfamilia!= "" && $idTipoSubfamilia!= "0") {
            $daoNutriente = new DaoNutriente();
            $arreglo = $daoNutriente->obtenerSubfamiliaNutriente($idTipoSubfamilia);
            if (count($arreglo) > 0) {
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Modificaci&oacute;n de Tipo subfamilia</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="tipo_subfamilia_editar.php" method="post" name="forma" id="forma">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <input type="hidden" name="tipo_familia" value="<?php echo $idTipoFamilia;?>" />
                                <input type="hidden" name="tipo_subfamilia" value="<?php echo $idTipoSubfamilia;?>" />
                                <div class="row">
        ...
        <script type="text/javascript">
            ...
            $('#volver').click(function() {
                location.href = 'tipo_subfamilia.php?tn=<?php echo $idTipoNutriente; ?>&tcla=<?php echo $idTipoClase; ?>&tcat=<?php echo $idTipoCategoria; ?>&tfam=<?php echo $idTipoFamilia ?>';
            });
