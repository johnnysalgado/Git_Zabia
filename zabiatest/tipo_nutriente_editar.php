<?php
    ...
    if (isset($_POST["tipo_nutriente"])) {
        ...
        $resultado = $daoNutriente->editarTipoNutriente($idTipoNutriente, $nombre, $nombreIngles, $estado, $usuario);
        $daoNutriente = null;

        header("Location: tipo_nutriente.php");
        die();
    }

    if (isset($_GET["id"])) {
        $idTipoNutriente= $_GET["id"];
        if ($idTipoNutriente!= "" && $idTipoNutriente!= "0") {
            $daoNutriente = new DaoNutriente();
            $arreglo = $daoNutriente->obtenerTipoNutriente($idTipoNutriente);
            if (count($arreglo) > 0) {
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Modificaci&oacute;n de Tipo nutriente</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="tipo_nutriente_editar.php" method="post" name="forma" id="forma">
                                <div class="row">
                                    <div class="col-md-6">
