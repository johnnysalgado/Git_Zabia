<?php
    ...
    if (isset($_POST['id_pregunta'])) {
        ...
        $idPreguntaPrecondicion = $_POST['id_pregunta_precondicion'];
        $orden = $_POST['orden'];
        $estado = $_POST['estado'];
        ...
        $daoCuestionario->editarPreguntaPrecondicion($idPreguntaPrecondicion, $orden, $none, $estado, $usuario);
        ...
        $daoCuestionario = new DaoCuestionario();
        if ($obtenerNuevos == "1") {
            $daoCuestionario->poblarPreguntaPrecondicion($idPregunta, $usuario);
        }
        $arregloPreguntaPrecondicion = $daoCuestionario->listarPreguntaPrecondicion($idPregunta, $estadoABuscar);
        if (count($arregloPreguntaPrecondicion) == 0 && $estadoABuscar == 1) {
            $daoCuestionario->poblarPreguntaPrecondicion($idPregunta, $usuario);
            $arregloPreguntaPrecondicion = $daoCuestionario->listarPreguntaPrecondicion($idPregunta, LISTA_ACTIVO);
        }
        $html = "<ol class=\"dd-list\">";
        foreach ($arregloPreguntaPrecondicion as $item) {
            $idPreguntaPrecondicion = $item['id_pregunta_enfermedad'];
            ...
            $html .= "<li class=\"dd-item dd3-item\" data-id=\"$idPreguntaPrecondicion\"> <div class=\"dd-handle dd3-handle $clase\"> </div>  <div class=\"dd3-content\" data-id=\"$idPreguntaPrecondicion\"> <input type=\"checkbox\" name=\"chk_eliminar[]\" value=\"$idPreguntaPrecondicion\" /> <span style=\"cursor:pointer;\" class=\"ver-option\" data-id=\"$idPreguntaPrecondicion\"> $descripcion </span> </div> </li>";
        }
        $html .= "</ol>";
        $descripcionPregunta = "";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-6">
                            <div class="white-box">
                                <form action="pregunta_enfermedad_eliminar.php" method="post" id="forma-eliminar">
                        ...
                        <div class="col-md-6 col-xs-8">
                            <div class="white-box">
                                <form action="pregunta_enfermedad.php" method="post" id="forma">
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="id_pregunta_precondicion" id="id_pregunta_precondicion" value="0" />
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var updateOutput = function(e) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "service/savehealthpreconditionorder.php",
                        data: {
                ...
                $('.ver-option').click(function() {
                    limpiarForma();
                    var idPreguntaPrecondicion = $(this).attr('data-id');
                    var param = { "healthPreconditionID" : idPreguntaPrecondicion };
                    var paramJSON = JSON.stringify(param);
                    $.ajax({
                        type: 'POST',
                        url: 'service/gethealthpreconditionbyid.php',
                        data: paramJSON,
                        dataType: 'json',
                        ...
                        success: function (result) {
                            console.log(result);
                            $('#id_pregunta_precondicion').val(result.data[0].healthPreconditionID);
                ...
                function limpiarForma() {
                    ...
                    $('#id_pregunta_precondicion').val('0');
                    $('#dato-registro').html('');
                    $('#dato-modifica').html('');
                }
                ...
                $('#listar-todo').click( function () {
                    ...
                    ?>
                    location.href = "pregunta_enfermedad.php?id_pregunta=<?php echo $idPregunta; ?>&e=" + estadoABuscar;
                });

                $('#obtener-nuevo').click( function() {
                    location.href = "pregunta_enfermedad.php?id_pregunta=<?php echo $idPregunta; ?>&e=<?php echo $estadoABuscar; ?>&on=1";
                });
