<?php
    ...
    if (isset($_POST["nombre"])) {
        ...
        if ($_FILES["fileToUpload"]["tmp_name"] != "") {
            ...
            $nombreImagen = PREFIJO_TRASTORNO_ESTOMACAL_ICONO . $ticks . "." . $imageFileType;
        ...
        $idTrastornoEstomacal = $daoTrastornoEstomacal->crearTrastornoEstomacal($nombre, $nombreIngles, $nombreImagen, $recomendacion, $recomendacionIngles, $referencia, $usuario);
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h4 class="page-title">Creaci&oacute;n de Trastorno Estomacal</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="trastorno_estomacal_crear.php" method="post" id="forma" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
