<?php
    ...
    if (isset($_POST["nombre"])) {
        ...
        $daoTipo = new DaoTipo();
        $daoTipo->crearTipoPlato($nombre, $nombreIngles, $nombreImagen, $estado, $usuario);
        $daoTipo = null;
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h4 class="page-title">Creaci&oacute;n de Tipo de plato</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="tipo_plato_crear.php" method="post" id="forma" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        ...
                                        <input type="button" id="nuevo-tipo-cplato" value="Grabar" class="btn btn-success" />
                                    </div>
                                </div>
                            </form>
                        </div>
