<?php
    ...
    if (isset($_POST["nombre"])) {
        ...
        $idTipoEmpleo = $daoUsuario->crearTipoEmpleo($nombre, $nombreIngles, $usuario);
        $daoUsuario = null;
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Creaci&oacute;n de Tipo empleo</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="tipo_empleo_crear.php" method="post" id="forma">
                                <div class="row">
                                    <div class="col-md-6">
