<?php
    ...
    if (isset($_POST["id_seccion_cuestionario"])) {
        ...
        $idSeccion = $daoCuestionario->actualizarSeccionCuestionarioMostrar($idSeccionCuestionario, $arregloPreguntaRespuestaAfecta, $usuario);
        ...
        if (is_numeric($idSeccionCuestionario)) {
            ...
            $arregloPreguntaRespuestaAfecta = $daoCuestionario->listarSeccionCuestionarioEnlazadaMostrar($idSeccionCuestionario);
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h4 class="page-title">Mostrar secci&oacute;n: <?php echo $descripcion; ?>, Si se activa las siguientes respuestas:</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="seccion_cuestionario_mostrar.php" method="post" id="forma">
