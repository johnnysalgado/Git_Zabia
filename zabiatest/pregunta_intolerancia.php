<?php
    ...
    if (isset($_POST['id_pregunta'])) {
        ...
        $idPreguntaIntolerancia = $_POST['id_pregunta_intolerancia'];
        $orden = $_POST['orden'];
        $estado = $_POST['estado'];
        ...
        $daoCuestionario->editarPreguntaIntolerancia($idPreguntaIntolerancia, $orden, $none, $estado, $usuario);
        $daoCuestionario = null;
        header("Location: pregunta_intolerancia.php?id_pregunta=$idPregunta&e=$estadoABuscar");
        die();
        ...
        $daoCuestionario = new DaoCuestionario();
        if ($obtenerNuevos == "1") {
            $daoCuestionario->poblarPreguntaIntolerancia($idPregunta, $usuario);
        }
        $arregloPreguntaIntolerancia = $daoCuestionario->listarPreguntaIntolerancia($idPregunta, $estadoABuscar);
        if (count($arregloPreguntaIntolerancia) == 0 && $estadoABuscar == 1) {
            $daoCuestionario->poblarPreguntaIntolerancia($idPregunta, $usuario);
            $arregloPreguntaIntolerancia = $daoCuestionario->listarPreguntaIntolerancia($idPregunta, LISTA_ACTIVO);
        }
        $html = "<ol class=\"dd-list\">";
        foreach ($arregloPreguntaIntolerancia as $item) {
            $idPreguntaIntolerancia = $item['id_pregunta_intolerancia'];
            ...
            $html .= "<li class=\"dd-item dd3-item\" data-id=\"$idPreguntaIntolerancia\"> <div class=\"dd-handle dd3-handle $clase\"> </div>  <div class=\"dd3-content\" data-id=\"$idPreguntaIntolerancia\"> <input type=\"checkbox\" name=\"chk_eliminar[]\" value=\"$idPreguntaIntolerancia\" /> <span style=\"cursor:pointer;\" class=\"ver-option\" data-id=\"$idPreguntaIntolerancia\"> $descripcion </span> </div> </li>";
        }
        $html .= "</ol>";
        $descripcionPregunta = "";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-6">
                            <div class="white-box">
                                <form action="pregunta_intolerancia_eliminar.php" method="post" id="forma-eliminar">
                        ...
                        <div class="col-md-6 col-xs-8">
                            <div class="white-box">
                                <form action="pregunta_intolerancia.php" method="post" id="forma">
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="id_pregunta_intolerancia" id="id_pregunta_intolerancia" value="0" />
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var updateOutput = function(e) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "service/savehealthintoleranceorder.php",
                        data: {
                ...
                $('.ver-option').click(function() {
                    limpiarForma();
                    var idPreguntaIntolerancia = $(this).attr('data-id');
                    var param = { "healthIntoleranceID" : idPreguntaIntolerancia };
                    var paramJSON = JSON.stringify(param);
                    $.ajax({
                        type: 'POST',
                        url: 'service/gethealthintolerancebyid.php',
                        data: paramJSON,
                        dataType: 'json',
                        ...
                        success: function (result) {
                            console.log(result);
                            $('#id_pregunta_intolerancia').val(result.data[0].healthIntoleranceID);
                ...
                function limpiarForma() {
                    ...
                    $('#id_pregunta_intolerancia').val('0');
                    $('#dato-registro').html('');
                    $('#dato-modifica').html('');
                }
                ...
                $('#listar-todo').click( function () {
                    ...
                    ?>
                    location.href = "pregunta_intolerancia.php?id_pregunta=<?php echo $idPregunta; ?>&e=" + estadoABuscar;
                });

                $('#obtener-nuevo').click( function() {
                    location.href = "pregunta_intolerancia.php?id_pregunta=<?php echo $idPregunta; ?>&e=<?php echo $estadoABuscar; ?>&on=1";
                });
