<?php
    ...
    if (isset($_POST["tipo_familia"])) {
        ...
        $resultado = $daoNutriente->editarTipoFamilia($idTipoFamilia, $nombre, $nombreIngles, $estado, $usuario);
        $daoNutriente = null;

        header("Location: tipo_familia.php?tn=$idTipoNutriente&tcla=$idTipoClase&tcat=$idTipoCategoria");
        die();
    }

    if (isset($_GET["id"])) {
        $idTipoFamilia= $_GET["id"];
        $idTipoCategoria= $_GET["tcat"];
        $idTipoClase= $_GET["tcla"];
        $idTipoNutriente= $_GET["tn"];
        if ($idTipoFamilia!= "" && $idTipoFamilia!= "0") {
            $daoNutriente = new DaoNutriente();
            $arreglo = $daoNutriente->obtenerFamiliaNutriente($idTipoFamilia);
            if (count($arreglo) > 0) {
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Modificaci&oacute;n de Tipo familia</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="tipo_familia_editar.php" method="post" name="forma" id="forma">
                                <div class="row">
                                    <div class="col-md-6">
        ...
        <script type="text/javascript">
            ...
            $('#volver').click(function() {
                location.href = 'tipo_familia.php?tn=<?php echo $idTipoNutriente; ?>&tcla=<?php echo $idTipoClase; ?>&tcat=<?php echo $idTipoCategoria; ?>';
            });
