<?php
    ...
    if (isset($_POST["id_tipo_empleo"])) {

        $idTipoEmpleo = $_POST["id_tipo_empleo"];
        $nombre = $_POST["nombre"];
        ...
        $resultado = $daoUsuario->editarTipoEmpleo($idTipoEmpleo, $nombre, $nombreIngles, $estado, $usuario);
        $daoUsuario = null;
        header("Location: tipo_empleo.php");
        die();
    
    } else {

        $idTipoEmpleo = $_GET["id"];
        $daoUsuario = new DaoUsuario();
        $arreglo = $daoUsuario->obtenerTipoEmpleo($idTipoEmpleo);
        if (count($arreglo)) {
            $item = $arreglo[0];
            $nombre = $item['nombre'];
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Modificaci&oacute;n de Tipo empleo</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="tipo_empleo_editar.php" method="post" id="forma">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <input type="hidden" id="id_tipo_empleo" name="id_tipo_empleo" value="<?php echo $idTipoEmpleo;?>" />
                            </form>
                        </div>
                    </div>
                </div>
