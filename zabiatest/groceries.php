<?php
    ...
    $query = "SELECT a.id_comercio, a.tipo_comercio, a.nombre, a.ciudad, a.imagen, a.estado FROM comercio a WHERE a.tipo_comercio = '" . TIPO_COMERCIO_GROCERY . "'  ORDER BY nombre";
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Tiendas de comestibles (Grocery)</h4>
                        </div>
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <div class="col-md-12 col-xs-12 text-right">
                            <input type="button" id="nuevo-comercio" value="Nueva tienda" class="btn btn-primary nuevo-comercio" />
                        </div>
                    </div>
                    <br />
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class="table-responsive">
                                <table id="comercio-table" class="table table-striped display">
                                    <thead>
                                        <tr>
                                            <th> ID </th>
                                            <th> Nombre </th>
        ...
        <script type="text/javascript">
            $('.td-comercio').click(function() {
                ...
                location.href = "grocery_editar.php?id=" + id_comercio;
            });

            $('.nuevo-comercio').click(function() {
                location.href = "grocery_crear.php";
            });
