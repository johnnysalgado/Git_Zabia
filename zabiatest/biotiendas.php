<?php
    ...
    $query = "SELECT a.id_comercio, a.tipo_comercio, a.nombre, a.ciudad, a.imagen, a.estado FROM comercio a WHERE a.tipo_comercio = '" . TIPO_COMERCIO_BIOTIENDA . "'  ORDER BY nombre";
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Bio tiendas</h4>
                        </div>
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <div class="col-md-12 col-xs-12 text-right">
                            <input type="button" id="nuevo-comercio" value="Nueva bio tienda" class="btn btn-primary nuevo-comercio" />
                        </div>
                    </div>
                    <br />
                    <div class="col-sm-12">
        ...
        <script type="text/javascript">
            $('.td-comercio').click(function() {
                ...
                location.href = "biotienda_editar.php?id=" + id_comercio;
            });

            $('.nuevo-comercio').click(function() {
                location.href = "biotienda_crear.php";
            });
