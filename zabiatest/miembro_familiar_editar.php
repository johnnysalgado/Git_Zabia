<?php
    ...
    if (isset($_POST["miembro_familiar"])) {
        $idMiembroFamiliar= $_POST["miembro_familiar"];
        $nombre = $_POST["nombre"];
        ...
        $resultado = $daoCuestionario->editarMiembroFamiliar($idMiembroFamiliar, $nombre, $nombreIngles, $estado, $usuario);
    ...
    if (isset($_GET["id"])) {
        $idMiembroFamiliar = $_GET["id"];
        if ($idMiembroFamiliar!= "" && $idMiembroFamiliar!= "0") {
            $daoCuestionario = new DaoCuestionario();
            $arreglo = $daoCuestionario->obtenerMiembroFamiliar($idMiembroFamiliar);
            if (count($arreglo) > 0) {
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Modificaci&oacute;n de Miembro familiar</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="miembro_familiar_editar.php" method="post" name="forma" id="forma">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <br />
                                <input type="hidden" name="miembro_familiar" value="<?php echo $idMiembroFamiliar; ?>" />
                                <div class="row">
