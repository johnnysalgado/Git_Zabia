<?php
    ...
    if (isset($_POST['id_pregunta'])) {
        ...
        $idPreguntaTipoDieta = $_POST['id_pregunta_tipo_dieta'];
        $orden = $_POST['orden'];
        $estado = $_POST['estado'];
        ...
        $daoCuestionario->editarPreguntaTipoDieta($idPreguntaTipoDieta, $orden, $none, $estado, $usuario);
        $daoCuestionario = null;
        header("Location: pregunta_tipo_dieta.php?id_pregunta=$idPregunta&e=$estadoABuscar");
        die();
        ...
        $daoCuestionario = new DaoCuestionario();
        if ($obtenerNuevos == "1") {
            $daoCuestionario->poblarPreguntaTipoDieta($idPregunta, $usuario);
        }
        $arregloPreguntaTipoDieta = $daoCuestionario->listarPreguntaTipoDieta($idPregunta, $estadoABuscar);
        if (count($arregloPreguntaTipoDieta) == 0 && $estadoABuscar == 1) {
            $daoCuestionario->poblarPreguntaTipoDieta($idPregunta, $usuario);
            $arregloPreguntaTipoDieta = $daoCuestionario->listarPreguntaTipoDieta($idPregunta, LISTA_ACTIVO);
        }
        $html = "<ol class=\"dd-list\">";
        foreach ($arregloPreguntaTipoDieta as $item) {
            $idPreguntaTipoDieta = $item['id_pregunta_tipo_dieta'];
            ...
            $html .= "<li class=\"dd-item dd3-item\" data-id=\"$idPreguntaTipoDieta\"> <div class=\"dd-handle dd3-handle $clase\"> </div>  <div class=\"dd3-content\" data-id=\"$idPreguntaTipoDieta\"> <input type=\"checkbox\" name=\"chk_eliminar[]\" value=\"$idPreguntaTipoDieta\" /> <span style=\"cursor:pointer;\" class=\"ver-option\" data-id=\"$idPreguntaTipoDieta\"> $descripcion </span> </div> </li>";
        }
        $html .= "</ol>";
        $descripcionPregunta = "";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-6">
                            <div class="white-box">
                                <form action="pregunta_tipo_dieta_eliminar.php" method="post" id="forma-eliminar">
                        ...
                        <div class="col-md-6 col-xs-8">
                            <div class="white-box">
                                <form action="pregunta_tipo_dieta.php" method="post" id="forma">
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="id_pregunta_tipo_dieta" id="id_pregunta_tipo_dieta" value="0" />
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var updateOutput = function(e) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "service/savehealthdiettypeorder.php",
                        data: {
                ...
                $('.ver-option').click(function() {
                    limpiarForma();
                    var idPreguntaTipoDieta = $(this).attr('data-id');
                    var param = { "healthDietTypeID" : idPreguntaTipoDieta };
                    var paramJSON = JSON.stringify(param);
                    $.ajax({
                        type: 'POST',
                        url: 'service/gethealthdiettypebyid.php',
                        data: paramJSON,
                        dataType: 'json',
                        ...
                        success: function (result) {
                            console.log(result);
                            $('#id_pregunta_tipo_dieta').val(result.data[0].healthDietTypeID);
                ...
                $('#listar-todo').click( function () {
                    ...
                    ?>
                    location.href = "pregunta_tipo_dieta.php?id_pregunta=<?php echo $idPregunta; ?>&e=" + estadoABuscar;
                });

                $('#obtener-nuevo').click( function() {
                    location.href = "pregunta_tipo_dieta.php?id_pregunta=<?php echo $idPregunta; ?>&e=<?php echo $estadoABuscar; ?>&on=1";
                });
