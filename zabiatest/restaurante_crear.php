<?php
    ...
    if (isset($_POST["tipo_comercio"])) {
        ...
        if ($uploadOk == 1) {
            ...
            $query = "INSERT INTO comercio (tipo_comercio, nombre, telefono, direccion, ciudad, latitud, longitud, descripcion, horario, reserva, url_carta, imagen, imagen_marker, usuario_registro) VALUES ('" . $tipoComercio . "', '" . $nombre . "', '" . $telefono . "', '" . $direccion . "', '" . $ciudad . "', '" . $latitud . "', '" . $longitud . "', '" . $descripcion . "', '" . $horario . "', '" . $reserva . "', '" . $urlCarta . "', '" . $nombreImagen . "', '" . $nombreImagenMarker . "', '" . $usuario . "');";
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Creaci&oacute;n de Restaurantes</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="restaurante_crear.php" method="post" enctype="multipart/form-data" name="forma_restaurante" id="forma-restaurante">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Nombre (*)</label>
                                            <input type="text" name="nombre" id="nombre" class="form-control" maxlength="256" />
                                            <input type="hidden" name="tipo_comercio" id="tipo_comercio" value ="<?php echo TIPO_COMERCIO_RESTAURANTE; ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Reserva</label>
                                            <input type="text" name="reserva" id="reserva" class="form-control" maxlength="32" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="url_carta" id="url_carta" class="form-control" maxlength="128" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
