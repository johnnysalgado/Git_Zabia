<?php
    ...
    if (isset($_POST["tipo_clase"])) {
        ...
        $resultado = $daoNutriente->editarTipoClase($idTipoClase, $nombre, $nombreIngles, $estado, $usuario);
        $daoNutriente = null;

        header("Location: tipo_clase.php?tn=$idTipoNutriente");
        die();
    }
    ...
    if (isset($_GET["id"])) {
        ...
        if ($idTipoClase!= "" && $idTipoClase!= "0") {
            $daoNutriente = new DaoNutriente();
            $arreglo = $daoNutriente->obtenerClaseNutriente($idTipoClase);
            if (count($arreglo) > 0) {
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Modificaci&oacute;n de Tipo clase</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="tipo_clase_editar.php" method="post" name="forma" id="forma">
                                <div class="row">
                                    <div class="col-md-6">
        ...
        <script type="text/javascript">
            ...
            $('#volver').click(function() {
                location.href = 'tipo_clase.php?tn=<?php echo $idTipoNutriente; ?>';
            });
