<?php
    ...
    if (isset($_POST["tipo_comercio"])) {
        ...
        if ($uploadOk == 1) {
            ...
            $cnx = null;
            header("Location: terapiaalternativas.php");
            die();
        }
    } 
?>
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-6 col-md-6 col-sm6 col-xs-12">
                            <h4 class="page-title">Creaci&oacute;n de terapia alternativa</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="terapiaalternativa_crear.php" method="post" enctype="multipart/form-data" name="forma_grocery" id="forma-grocery">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Nombre (*)</label>
                                            <input type="text" name="nombre" id="nombre" class="form-control" maxlength="256" />
                                            <input type="hidden" name="tipo_comercio" id="tipo_comercio" value ="<?php echo TIPO_COMERCIO_TERAPIAALTERNATIVA; ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
        ...
        <script type="text/javascript">
            ...
            $('#volver').click(function() {
                location.href = 'terapiaalternativas.php';
            });
