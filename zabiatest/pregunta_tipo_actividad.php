<?php
    ...
    if (isset($_POST['id_pregunta'])) {
        ...
        $idPreguntaTipoActividad = $_POST['id_pregunta_tipo_actividad'];
        $orden = $_POST['orden'];
        $estado = $_POST['estado'];
        ...
        $daoCuestionario->editarPreguntaTipoActividad($idPreguntaTipoActividad, $orden, $none, $estado, $usuario);
        ...
        $daoCuestionario = new DaoCuestionario();
        if ($obtenerNuevos == "1") {
            $daoCuestionario->poblarPreguntaTipoActividad($idPregunta, $usuario);
        }
        $arregloPreguntaTipoActividad = $daoCuestionario->listarPreguntaTipoActividad($idPregunta, $estadoABuscar);
        if (count($arregloPreguntaTipoActividad) == 0 && $estadoABuscar == 1) {
            $daoCuestionario->poblarPreguntaTipoActividad($idPregunta, $usuario);
            $arregloPreguntaTipoActividad = $daoCuestionario->listarPreguntaTipoActividad($idPregunta, LISTA_ACTIVO);
        }
        $html = "<ol class=\"dd-list\">";
        foreach ($arregloPreguntaTipoActividad as $item) {
            $idPreguntaTipoActividad = $item['id_pregunta_tipo_actividad'];
            ...
            $html .= "<li class=\"dd-item dd3-item\" data-id=\"$idPreguntaTipoActividad\"> <div class=\"dd-handle dd3-handle $clase\"> </div>  <div class=\"dd3-content\" data-id=\"$idPreguntaTipoActividad\"> <input type=\"checkbox\" name=\"chk_eliminar[]\" value=\"$idPreguntaTipoActividad\" /> <span style=\"cursor:pointer;\" class=\"ver-option\" data-id=\"$idPreguntaTipoActividad\"> $descripcion </span> </div> </li>";
        }
        $html .= "</ol>";
        $descripcionPregunta = "";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-6">
                            <div class="white-box">
                                <form action="pregunta_tipo_actividad_eliminar.php" method="post" id="forma-eliminar">
                        ...
                        <div class="col-md-6 col-xs-8">
                            <div class="white-box">
                                <form action="pregunta_tipo_actividad.php" method="post" id="forma">
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="id_pregunta_tipo_actividad" id="id_pregunta_tipo_actividad" value="0" />
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var updateOutput = function(e) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "service/savehealthactivitytypeorder.php",
                        data: {
                ...
                $('.ver-option').click(function() {
                    limpiarForma();
                    var idPreguntaTipoActividad = $(this).attr('data-id');
                    var param = { "healthActivityTypeID" : idPreguntaTipoActividad };
                    var paramJSON = JSON.stringify(param);
                    $.ajax({
                        type: 'POST',
                        url: 'service/gethealthactivitytypebyid.php',
                        data: paramJSON,
                        dataType: 'json',
                        ...
                        success: function (result) {
                            console.log(result);
                            $('#id_pregunta_tipo_actividad').val(result.data[0].healthActivityTypeID);
                ...
                function limpiarForma() {
                    ...
                    $('#id_pregunta_tipo_actividad').val('0');
                    $('#dato-registro').html('');
                    $('#dato-modifica').html('');
                }
                ...
                $('#listar-todo').click( function () {
                    ...
                    ?>
                    location.href = "pregunta_tipo_actividad.php?id_pregunta=<?php echo $idPregunta; ?>&e=" + estadoABuscar;
                });

                $('#obtener-nuevo').click( function() {
                    location.href = "pregunta_tipo_actividad.php?id_pregunta=<?php echo $idPregunta; ?>&e=<?php echo $estadoABuscar; ?>&on=1";
                });
