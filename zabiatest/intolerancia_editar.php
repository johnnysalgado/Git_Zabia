<?php
    ...
    if (isset($_POST["id_intolerancia"])) {

        $idIntolerancia = $_POST["id_intolerancia"];
        $nombre = $_POST["nombre"];
        ...
        if ($_FILES["fileToUpload"]["tmp_name"] != "") {
            $nombreImagen = PREFIJO_INTOLERANCIA_ICONO . $idIntolerancia . "_" . basename($_FILES["fileToUpload"]["name"]);
        ...
        $daoIntolerancia->editarIntolerancia($idIntolerancia, $nombre, $nombreIngles, $nombreImagen, $recomendacion, $recomendacionIngles, $referencia, $estado, $usuario);
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h4 class="page-title">Modificaci&oacute;n de Intolerancia</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="intolerancia_editar.php" method="post" id="forma" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
