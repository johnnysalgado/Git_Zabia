<?php
    ...
    if (isset($_POST["id_pregunta"])) {
        ...
        $idSeccion = $daoCuestionario->actualizarPreguntaMostrar($idPregunta, $arregloPreguntaRespuestaAfecta, $usuario);
        ...
        if (is_numeric($idPregunta)) {
            ...
            $arregloPreguntaRespuestaAfecta = $daoCuestionario->listarPreguntaEnlazadaMostrar($idPregunta);
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h4 class="page-title">Mostrar pregunta: <?php echo $descripcion; ?>, Si se activa las siguientes respuestas:</h4>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form action="pregunta_mostrar.php" method="post" id="forma">
